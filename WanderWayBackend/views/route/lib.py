...
def _generate_poi_img(poi):
    search_url = f"https://maps.googleapis.com/maps/api/place/nearbysearch/json?location={poi.latitude},{poi.longitude}&radius=50&key={config('GOOGLE_MAPS_API_KEY')}"
